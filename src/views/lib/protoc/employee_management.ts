...
class InsertFileRequest$Type extends MessageType<InsertFileRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: InsertFileRequest): InsertFileRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: InsertFileRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
...
class GetFileRequest$Type extends MessageType<GetFileRequest> {
    constructor() {
        super("employee_management.GetFileRequest", [
            ...
            { no: 3, name: "path", kind: "scalar", oneof: "identifier", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class UpdateFileRequest$Type extends MessageType<UpdateFileRequest> {
    constructor() {
        super("employee_management.UpdateFileRequest", [
            ...
            { no: 2, name: "name", kind: "scalar", oneof: "identifier", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "path", kind: "scalar", oneof: "identifier", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "owner_id", kind: "scalar", oneof: "identifier", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: UpdateFileRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.identifier.oneofKind === "ownerId")
            writer.tag(4, WireType.LengthDelimited).string(message.identifier.ownerId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
