...
/**
 * @generated from protobuf message employee_management.InsertFileRequest
 */
	...
	constructor() {
		super("employee_management.User", [
			...
			{ no: 2, name: "email", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{
				...
				name: "role",
				kind: "enum",
				T: () => ["employee_management.Role", Role],
			},
...
class UpdateUserEmailRequest$Type extends MessageType<UpdateUserEmailRequest> {
	...
	create(
		value?: PartialMessage<UpdateUserEmailRequest>,
...
class UpdateUserPasswordRequest$Type extends MessageType<UpdateUserPasswordRequest> {
	...
	create(
		value?: PartialMessage<UpdateUserPasswordRequest>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: UpdateUserPasswordRequest,
	): UpdateUserPasswordRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* employee_management.User owner */ 4:
					message.owner = User.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.owner,
...
// @generated message type with reflection information, may provide speed optimized methods
class InsertFileRequest$Type extends MessageType<InsertFileRequest> {
	constructor() {
		super("employee_management.InsertFileRequest", [
			{ no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{ no: 2, name: "path", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
			{ no: 3, name: "owner_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
		]);
	}
	create(value?: PartialMessage<InsertFileRequest>): InsertFileRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.name = "";
		message.path = "";
		message.ownerId = "";
		if (value !== undefined)
			reflectionMergePartial<InsertFileRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
...
/**
 * @generated MessageType for protobuf message employee_management.InsertFileRequest
 */
export const InsertFileRequest = new InsertFileRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetFileRequest$Type extends MessageType<GetFileRequest> {
	...
	internalBinaryWrite(
		...
		/* string path = 3; */
		if (message.identifier.oneofKind === "path")
			writer.tag(3, WireType.LengthDelimited).string(message.identifier.path);
		let u = options.writeUnknownFields;
		if (u !== false)
			(u == true ? UnknownFieldHandler.onWrite : u)(
				this.typeName,
	...
	internalBinaryWrite(
		...
		if (message.identifier.oneofKind === "ownerId")
			writer
				...
				.string(message.identifier.ownerId);
		let u = options.writeUnknownFields;
		if (u !== false)
			(u == true ? UnknownFieldHandler.onWrite : u)(
				this.typeName,
...
class Employee$Type extends MessageType<Employee> {
	constructor() {
		super("employee_management.Employee", [
			...
			},
			{
				...
				name: "contract_type",
				kind: "enum",
				T: () => ["employee_management.ContractType", ContractType],
			},
	...
	internalBinaryWrite(
		...
		if (message.sex !== 0) writer.tag(6, WireType.Varint).int32(message.sex);
		/* string address = 7; */
		if (message.address !== "")
...
class InsertEmployeeRequest$Type extends MessageType<InsertEmployeeRequest> {
	...
	internalBinaryWrite(
		...
		if (message.sex !== 0) writer.tag(5, WireType.Varint).int32(message.sex);
		/* string address = 6; */
		if (message.address !== "")
	...
	internalBinaryWrite(
		...
		if (message.identifier.oneofKind === "contactNumber")
			writer
				...
				.string(message.identifier.contactNumber);
	...
	constructor() {
		super("employee_management.Task", [
			...
			},
			{
				...
				name: "status",
				kind: "enum",
				T: () => ["employee_management.TaskStatus", TaskStatus],
			},
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* employee_management.Employee issued_by_user */ 5:
					message.issuedByUser = Employee.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
				...
				case /* repeated employee_management.Employee assigned_to */ 6:
					message.assignedTo.push(
						Employee.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				case /* repeated employee_management.TaskComment comments */ 7:
					message.comments.push(
						TaskComment.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
...
class GetTaskRequest$Type extends MessageType<GetTaskRequest> {
	...
	internalBinaryWrite(
		...
		if (message.identifier.oneofKind === "issuedByUser")
			writer
				.tag(4, WireType.LengthDelimited)
				.string(message.identifier.issuedByUser);
		/* string deadline = 5; */
		if (message.identifier.oneofKind === "deadline")
			writer
				.tag(5, WireType.LengthDelimited)
				.string(message.identifier.deadline);
		let u = options.writeUnknownFields;
		if (u !== false)
			(u == true ? UnknownFieldHandler.onWrite : u)(
				this.typeName,
...
class UpdateTaskRequest$Type extends MessageType<UpdateTaskRequest> {
	...
	internalBinaryWrite(
		...
		if (message.identifier.oneofKind === "newTitle")
			writer
				.tag(2, WireType.LengthDelimited)
				.string(message.identifier.newTitle);
		/* string new_description = 3; */
		if (message.identifier.oneofKind === "newDescription")
			writer
				.tag(3, WireType.LengthDelimited)
				.string(message.identifier.newDescription);
		...
		if (message.identifier.oneofKind === "newIssuedByUser")
			writer
				.tag(5, WireType.LengthDelimited)
				.string(message.identifier.newIssuedByUser);
		/* string new_deadline = 6; */
		if (message.identifier.oneofKind === "newDeadline")
			writer
				.tag(6, WireType.LengthDelimited)
				.string(message.identifier.newDeadline);
		let u = options.writeUnknownFields;
		if (u !== false)
			(u == true ? UnknownFieldHandler.onWrite : u)(
				this.typeName,
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* employee_management.Employee employee */ 3:
					message.employee = Employee.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.employee,
				...
				case /* employee_management.File attachment */ 5:
					message.attachment = File.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.attachment,
...
class InsertTaskCommentRequest$Type extends MessageType<InsertTaskCommentRequest> {
	...
	create(
		value?: PartialMessage<InsertTaskCommentRequest>,
	): InsertTaskCommentRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.taskId = "";
		message.userId = "";
		message.comment = "";
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: InsertTaskCommentRequest,
	): InsertTaskCommentRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
class UpdateTaskCommentRequest$Type extends MessageType<UpdateTaskCommentRequest> {
	...
	create(
		value?: PartialMessage<UpdateTaskCommentRequest>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: UpdateTaskCommentRequest,
	): UpdateTaskCommentRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
class DeleteTaskCommentRequest$Type extends MessageType<DeleteTaskCommentRequest> {
	...
	create(
		value?: PartialMessage<DeleteTaskCommentRequest>,
	...
	internalBinaryRead(
		...
		length: number,
		options: BinaryReadOptions,
		target?: DeleteTaskCommentRequest,
	): DeleteTaskCommentRequest {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
...
export const FileService = new ServiceType("employee_management.FileService", [
	{ name: "InsertFile", options: {}, I: InsertFileRequest, O: File },
 ...
 */
export const EmployeeService = new ServiceType(
	"employee_management.EmployeeService",
	[
		{
			name: "InsertEmployee",
			options: {},
			I: InsertEmployeeRequest,
			O: Employee,
		},
 ...
 */
export const TaskCommentService = new ServiceType(
	"employee_management.TaskCommentService",
	[
		{
			name: "InsertTaskComment",
			options: {},
			I: InsertTaskCommentRequest,
			O: TaskComment,
		},
		{
			name: "GetTaskComment",
			options: {},
			I: GetTaskCommentRequest,
			O: TaskComment,
		},
		{
			name: "UpdateTaskComment",
			options: {},
			I: UpdateTaskCommentRequest,
			O: TaskComment,
		},
		{
			name: "DeleteTaskComment",
			options: {},
			I: DeleteTaskCommentRequest,
			O: Empty,
		},
	],
);
